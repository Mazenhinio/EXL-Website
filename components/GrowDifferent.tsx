...
const pillars = [
  {
    id: '01',
    title: 'PIPELINE IS THE ONLY',
    highlight: 'METRIC THAT COUNTS.',
    body: 'Impressions, clicks, and engagement rates are diagnostic. Pipeline is the outcome. Every Grow engagement is scoped and reported against pipeline, and we will push back if you ask us to report against anything less.',
    image: '/assets/images/b2b_prob_distribution.png'
  },
  {
    id: '02',
    title: 'ONE TEAM RUNNING PAID,',
    highlight: 'ORGANIC, AND CRM.',
    body: 'Most agencies silo these functions. We don\'t. The paid team sees what\'s happening in the nurture flow. The CRM team sees which ads are bringing in the right buyers. The result is a system, not a stack of disconnected tactics.',
    image: '/assets/images/produce-pillar3-team.png'
  },
  {
    id: '03',
    title: 'THE AUTOMATION LAYER IS',
    highlight: 'BUILT TO SCALE.',
    body: 'We don\'t just set campaigns up, we build the operating system underneath them. That means when your volume doubles, the system doesn\'t break, and you don\'t have to rebuild.',
    image: '/assets/images/b2b_get_set.png'
  }
]

export default function GrowDifferent() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-20 flex flex-col items-center relative z-20">
        ...
        >
          Three reasons brands choose <span className="text-[var(--chartreuse)]">Grow.</span>
        </h2>
      </div>
