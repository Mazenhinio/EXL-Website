...
export default function ProduceSection7() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set('.produce-laser-line', { scaleY: 0, transformOrigin: 'top center' })
      gsap.set('.produce-left-content', { opacity: 0, x: -60 })
      gsap.set('.produce-right-content', { opacity: 0, x: 60 })

      // 1. Draw the central Chartreuse laser line
      tl.to('.produce-laser-line', { scaleY: 1, duration: 2, ease: 'power2.inOut' })
      ...
      tl.to('.produce-left-content', { opacity: 1, x: 0, duration: 1.5, ease: 'power2.out' }, '-=1.2')
        .to('.produce-right-content', { opacity: 1, x: 0, duration: 1.5, ease: 'power2.out' }, '<')
  ...
  return (
    ...
    >
      ...
      <div 
        className="produce-laser-line absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-[2px] bg-[var(--chartreuse)] shadow-[0_0_15px_#DEFF00] z-30 pointer-events-none" 
      />
      ...
      >
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Cinematic production studio visual fit" 
            fill 
            className="object-cover opacity-[0.22] contrast-[1.1] saturate-[0.8]"
            priority
          />
        ...
        <div className="produce-left-content relative z-20 w-full max-w-2xl ml-auto mr-0 px-8 lg:px-14 flex flex-col justify-center">
          ...
          <div className="flex flex-col gap-5">
            {[
              'Brands that treat content as a commercial asset, not an internal expense.',
              'Companies with something real to say, who invest in saying it well.',
              'Marketing leaders tired of explaining why their video looks like stock.',
              'Sponsors who know that cinema-quality visuals earn true active attention.'
            ].map((text, idx) => (
              <div key={idx} className="bg-black/50 border border-white/10 p-5 rounded-2xl flex gap-4 items-start shadow-xl">
                ...
                <p className="font-[var(--font-cabinet)] text-white text-base md:text-lg leading-relaxed m-0 font-light">
                  {text}
                </p>
              </div>
            ))}
      ...
      >
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Corporate fluorescent cubicle office non-fit" 
            fill 
            className="object-cover opacity-[0.16] contrast-[1.1] grayscale"
            priority
          />
        ...
        <div className="produce-right-content relative z-25 w-full max-w-2xl mr-auto ml-0 px-8 lg:px-14 flex flex-col justify-center">
          <span className="font-[var(--font-mona-narrow)] text-[10px] tracking-[0.2em] text-white/40 uppercase block font-bold mb-4">
            THE BOUNDARY
          </span>
          <h3 
            style={{ 
          ...
          <div className="flex flex-col gap-5">
            {[
              'Companies seeking rapid webcam-style talking heads or cheap templates.',
              'Departments seeking generic agency slides instead of real cinematic assets.',
              'Projects focused solely on low-cost high-volume noise rather than real engagement.'
            ].map((text, idx) => (
