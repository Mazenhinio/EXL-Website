...
export default function ProduceFooterCTA() {
  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden px-6 pb-20 md:pb-28">
        ...
        >
          <img 
            ...
            alt="EXL Logo Mark"
            className="w-full h-full object-contain transition-all duration-300 group-hover:rotate-6"
            style={{ filter: 'invert(1) brightness(0)', WebkitFilter: 'invert(1) brightness(0)' }}
          />
        </div>
        ...
        >
          ...
          <div className="bg-black/5 backdrop-blur-md rounded-[2rem] p-8 border border-black/10 max-w-2xl mx-auto mb-10 text-black/90 font-medium text-lg md:text-xl font-[var(--font-cabinet)] leading-relaxed shadow-lg">
            Tell us what you want to say. We&apos;ll tell you how to shoot it.
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            >
              <span className="font-[var(--font-cabinet)] font-bold text-lg md:text-xl">Book a call</span>
