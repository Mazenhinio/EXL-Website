...
const pillars = [
  {
    ...
    body: 'Every frame shot and lit the way a film crew would. Every sound captured the way a record label would. Every edit cut for attention, not for duration. We don\'t ship work we wouldn\'t watch.',
    image: '/assets/images/produce-pillar1-craft.png'
  },
  {
    id: '02',
    title: 'AI-ACCELERATED',
    highlight: 'POST-PRODUCTION.',
    body: 'Our edit room is built on AI-assisted tooling that handles the mechanical work of editing, so our editors spend their hours on the creative decisions that actually matter. You get faster turnarounds without any loss in craft.',
    image: '/assets/images/produce-pillar2-edit.png'
  },
  {
    id: '03',
    title: 'FULL IN-HOUSE TEAM,',
    highlight: 'NO FREELANCER CHAOS.',
    body: 'Most agencies hire crew by the project. We employ ours. That means consistent quality, consistent communication, and a team that actually knows your brand by the third shoot.',
    image: '/assets/images/produce-pillar3-team.png'
  }
]

export default function ProduceSection4() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-20 flex flex-col items-center relative z-20">
        <p className="font-[var(--font-mona-narrow)] text-[10px] tracking-[0.2em] text-[var(--chartreuse)] uppercase block font-bold mb-4">
          Why Clients Choose Produce
        </p>
        ...
        >
          Three reasons brands choose <span className="text-[var(--chartreuse)]">Produce.</span>
        </h2>
      </div>
