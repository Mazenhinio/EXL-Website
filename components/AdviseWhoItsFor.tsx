...
export default function AdviseWhoItsFor() {
  ...
  useEffect(() => {
    const loadGsap = async () => {
      ...
      const ctx = gsap.context(() => {
        ...
        gsap.set('.advise-laser-line', { scaleY: 0, transformOrigin: 'top center' })
        gsap.set('.advise-left-content', { opacity: 0, x: -60 })
        gsap.set('.advise-right-content', { opacity: 0, x: 60 })

        // 1. Draw the central Chartreuse laser line
        tl.to('.advise-laser-line', { scaleY: 1, duration: 2, ease: 'power2.inOut' })
        ...
        tl.to('.advise-left-content', { opacity: 1, x: 0, duration: 1.5, ease: 'power2.out' }, '-=1.2')
          .to('.advise-right-content', { opacity: 1, x: 0, duration: 1.5, ease: 'power2.out' }, '<')
  ...
  return (
    ...
    >
      ...
      <div 
        className="advise-laser-line absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-[2px] bg-[var(--chartreuse)] shadow-[0_0_15px_#DEFF00] z-30 pointer-events-none" 
      />
      ...
      >
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Premium Strategy Boardroom" 
            fill 
        ...
        <div className="advise-left-content relative z-20 w-full max-w-2xl ml-auto mr-0 px-8 lg:px-14 flex flex-col justify-center">
          <span className="font-[var(--font-tusker)] text-[11px] font-bold text-[var(--chartreuse)] tracking-[0.3em] uppercase mb-4 block">
            THE ALIGNMENT
          </span>
          <h2 
          ...
          <div className="flex flex-col gap-5">
            {[
              'Founders and CEOs who need a senior marketing voice in the room.',
              'CMOs who need an outside partner to pressure-test their plan.',
              'Private equity operators briefing a portfolio company.',
              'Companies where the stakes are high enough to demand senior thinking.'
            ].map((text, idx) => (
      ...
      >
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Boilerplate Template Agency Setup" 
            fill 
        ...
        <div className="advise-right-content relative z-25 w-full max-w-2xl mr-auto ml-0 px-8 lg:px-14 flex flex-col justify-center">
          <span className="font-[var(--font-tusker)] text-[11px] font-bold text-white/40 tracking-[0.3em] uppercase mb-4 block">
            THE BOUNDARY
          </span>
          <h3 
            style={{ 
          ...
          <div className="flex flex-col gap-5">
            {[
              'A company looking for a templated brand workshop or boilerplate checklist.',
              'A basic keyword search audit or generic outsourced SEO list.',
              'A PowerPoint deck written to a price point, not a rigorous standard.'
            ].map((text, idx) => (
