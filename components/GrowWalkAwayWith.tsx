...
const deliverables = [
  {
    num: '01',
    title: 'WORKING PAID MEDIA',
    highlight: 'WEEKLY DRILLS.',
    desc: 'A working paid media program with weekly optimization and monthly strategic reviews. Scoped against pipeline benchmarks, optimized constantly to compress client acquisition costs.',
    bullets: ['Constant Bid Drills', 'Clear Pipeline ROI']
  },
  {
    num: '02',
    title: 'ORGANIC REPURPOSING',
    highlight: 'SYSTEM COMPOUNDS.',
    desc: 'An organic distribution system that compounds without your team running it manually. Every podcast or hero asset converts into a multi-channel swarm of organic reach.',
    bullets: ['1-to-15 Asset Swarms', 'Zero Manual Effort']
  },
  {
    num: '03',
    title: 'NURTURE AND LIFE CYCLES',
    highlight: 'NIGHTLY PIPELINE.',
    desc: 'A nurture and automation layer that follows up every lead while your team sleeps. Fully integrated behavioral CRM sequencing that routes hot pipeline to sales instantly.',
    bullets: ['Behavioral CRM Plugs', 'Automated Lead Plumb']
  },
  {
    num: '04',
    title: 'PIPELINE DASHBOARDS',
    highlight: 'CEO UNDERSTANDS.',
    desc: 'Pipeline dashboards your CEO will understand in 30 seconds. Attribution dashboards showing which channels actually drove cash flow, not just empty clicks.',
    bullets: ['30-Sec CEO Readout', 'Full Revenue Tracking']
  }
]
...
export default function GrowWalkAwayWith() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo('.grow-carousel-wrapper', 
        { opacity: 0, y: 50 },
        {
          opacity: 1,
          y: 0,
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 w-full relative z-10">
        ...
        <div className="grow-carousel-wrapper opacity-0">
          <div 
            ref={scrollRef}
